...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/rubocop/lts/ruby/my_class.rb` -> `spec/rubocop/lts/ruby/my_class_spec.rb`.
...
[🧪build]: https://github.com/rubocop-lts/rubocop-lts-ruby/actions
