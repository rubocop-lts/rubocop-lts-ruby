# kettle-jem:freeze
# To retain chunks of comments & code during rubocop-lts-ruby templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# rubocop-lts-ruby will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
